...
* [속죄](./Messengers_Resource.md#redemption)의 "불채찍 60대" 부분은 다음을 참조한다.
  ```text
  3 Enoch 16:5
  ...
  * "메타트론"과 "아나피엘"은 "Sar HaPanim (얼굴의 천사, 임재의 천사)" 소속이다.
    ...
    * 이러한 명칭상의 특징은 [천국](./Messengers_Resource.md#heaven) 묘사에 대한 제한으로도 이어진다.
* [연옥](./Messengers_Resource.md#purgatorium)의 네하르 디누르는 "Book of Daniel", "1 ENOCH", "3 ENOCH"의 "נְהַר דִּי-נ֥וּר"를 참조한다.
...
* [완곡어법](./Messengers_Main.md#euphemism) 대사 중 "인자여, 너는 은밀한 것을 알아내기 위하여 이것을 구하는도다." 부분은 다음을 참조한다.
  ```text
  1 Enoch 60:10
...
* [완곡어법](./Messengers_Main.md#euphemism) 주석 중 "온화한 날개가 달래야 하는 하늘 속에서 계속 비추고 있으되, 달래야 하는 하늘은 그것을 깨닫지 못하였도다." 부분은 다음을 참조한다.
  ...
  ```
* [융합주의](./Messengers_Main.md#syncretism) 대사 중 "나는 입이 없다. 그리고 나는 슬피 울며 이를 갈아야 한다." 부분은 다음을 참조한다.
