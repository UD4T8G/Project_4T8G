...
```
* [연옥](./Messengers_Resource.md#purgatorium)의 네하르 디누르는 "Book of Daniel", "1 ENOCH", "3 ENOCH"의 "נְהַר דִּי-נ֥וּר"를 참조하지만, 전례서상의 "연옥"은 다음을 참조한다. 또한 [첫 데이트](./Messengers_Main.md#first-date)의 게힌놈은 "Hesychasm", "Palamism"을 참조하므로 네하르 디누르의 성질을 지닌다.
```text
2 MACCABEES 12:44
