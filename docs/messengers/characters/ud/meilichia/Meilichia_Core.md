...
| :--- | :--- |
| **특성** | 검사<br>돌진<br>패링 |
| **기본** | [듀얼 소드](#dual_sword) 형태로 회전하면서 빠르게 베기<br>[듀얼 소드](#dual_sword) 형태로 돌진하면서 빠르게 찌르기 |
| **특수** | [투핸더](#two_hander) 형태로 캐스팅 후 돌진하면서 빠르게 베기 |
| **궁극** | [다이폴](#dipole)을 던져 오브젝트를 지속적으로 베고 회수<br>충전 후 [다이폴](#dipole)을 손 위에 반중력 회전 비행시키며 지속적으로 오브젝트 요격 |
...
| **장비** | [홀스터](#holster) |
| :--- | :--- |
| **특성** | 웨펀 마스터<br>탄막<br>저격<br>패링 |
| **기본** | [듀얼 위일드](#dual_wield) 형태로 지속적으로 빠르게 사격 |
| **특수** | [더블 배럴](#double_barrel) 형태로 캐스팅 후 단일 사격 |
| **궁극** | [바이폴라](#bipolar)를 던져 오브젝트를 지속적으로 사격하고 회수<br>[바이폴라](#bipolar)를 손 위에 반중력 회전 비행시키며 지속적으로 오브젝트 요격 |

#### 거리 조절

---

| **장비** | [신체 개조](#body_modification) |
| :--- | :--- |
| **특성** | 스피드스터<br>비행<br>돌진<br>탄막<br>패링 |
| **기본** | 비행하면서 [스캐버드](#scabbard)로 찌르기 후 지나가기<br>회전하면서 전방위 오브젝트를 [스캐버드](#scabbard)로 지속적으로 베기 |
| **특수** | 비행하면서 [홀스터](#holster)로 사격 후 지나가기<br>회전하면서 전방위 오브젝트를 [홀스터](#holster)로 지속적으로 사격 |
| **궁극** | 회전 비행하면서 [스캐버드](#scabbard)로 지속적으로 찌르기와 베기를 가하고 [홀스터](#holster)로 지속적으로 사격 후 지나가기 |
