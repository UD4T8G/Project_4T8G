...
* **밀키 기획 이전:**
  - [버디](../buddy/Buddy_Header.md)의 일부로서, 오른팔 대신 사슬팔을 사용하는 소녀로 구상되었다.
    + [버디](../buddy/Buddy_Header.md)를 오른팔로 장착하여 사용하고, [버디](../buddy/Buddy_Header.md)의 동력이 되는 등의 폼 체인지를 선보였다.
    + *Devil May Cry* 시리즈의 *Nero*, *SANABI*의 *Protagonist* 등등에서 겹치는 요소가 많았고, 독창성이 부족해지면서 결국 구현되지 않았다.
  - *페록스(Ferox)* 라는 캐릭터를 구상하고 있었다.
    + *갓 슬레이어* 세계관이 무산되면서 [홀스터](./Milky_Header.md#holster)와 [멀티폴](./Milky_Header.md#multipole)에 구현되었다.
    ...
    + *제트파워블레이드팩(Jet-Power-Blade-Pack)* 장비를 사용한다.
      * 기본적으로는 제트팩이다.
