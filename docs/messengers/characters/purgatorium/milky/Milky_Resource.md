...
* 권총 형태의 [모노폴](#multipole)을 들고 지속적으로 빠르게 사격한다.
...
* 말굽자석 형태의 [바이폴](#multipole)을 충전하고 폭발시켜 주변의 모든 것의 벡터를 일시적으로 조작한다.
...
* **뱀이 저를 꾀어서 제가 따 먹었습니다:**
  ...
  * [스네이크](#snake)를 수복시켜서 사용하고 있을 경우 [날개](../../../core/messengers/Messengers_Resource.md#wings)의 충전량에 비례하여 무형성이 지속적으로 감소한다.