...
* 밀키와 [스네이크](./Milky_Core.md#snake)의 설정은 다음을 참조한다.
  ```text
  "Meilichios" (남성) 계열
  ...
  * "Meilichios"와 "Meilichia"는 "달래야 하는"으로 번역되며, 이는 "Euphemism"이다.
    * [스네이크](./Milky_Core.md#snake)가 밀키의 성격을 무겁게 만든다는 점은 "달래야 하는" 특성을 참조한다.
...
* 밀키의 [날개](../../../core/messengers/Messengers_Core.md#wings)에 해당하는 [사태극](./Milky_Core.md#sitaegeuk)은 "십자가"를 참조한다.
* 상단의 문장은 다음을 참조한다.
  ```text
  LUKA 12:49
    Πῦρ ἦλθον βαλεῖν ἐπὶ τὴν γῆν, καὶ τί θέλω εἰ ἤδη ἀνήφθη.
  ```
* 죽음의 탭댄스, 기관단총 대각합체 형태의 [다이폴](./Milky_Core.md#dipole)은 "Sten Machine Carbine"의 "Sten Stepping"을 참조한다.