...
> *밀키는 소매를 걷어올린 청색 십자가의 백색 갑주, 청색 벨트의 흑색 반바지, 청색 끈의 흑색 부츠를 착용하고 있다.*

> *[순교자들의 융합](#fusion_of_martyrs)은 회색의 [융합로](#fusion_core)가 폭발하고, 모든 청색광이 금 나노 입자의 적색광으로 바뀐다.*

> *[스네이크](#snake)는 백색 수염을 기른 벽안의 백색 뱀이며, 모두 [봉인](#seal)하거나 [해제](#unseal)한 밀키의 성격은 가벼워진다.*

> *[스네이크](#snake)는 그 수가 무수히 많고, 서로 다른 자아를 지니고 있으며, 무거운 성격으로 밀키의 성격에 영향을 미친다.*
...
* 밀키와 [스네이크](#snake)의 설정은 다음을 참조한다.
  ...
  * "Meilichios"와 "Meilichia"는 "달래야 하는"으로 번역되며, 이는 "Euphemism"이다.
    * [스네이크](#snake)가 밀키의 성격을 무겁게 만든다는 점은 "달래야 하는" 특성을 참조한다.
...
* 상단의 문장은 다음을 참조한다.
  ...
  ```
* 죽음의 탭댄스, 기관단총 대각합체 형태의 [다이폴](#dipole)은 "Sten Machine Carbine"의 "Sten Stepping"을 참조한다.