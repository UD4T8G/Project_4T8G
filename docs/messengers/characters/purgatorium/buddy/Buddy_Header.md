...
* **포메이션:**
  - [심판의 화살](#judgment-bolt)이 중력을 무시하고 속력을 조절한다.
  - [심판의 화살](#judgment-bolt)이 버디의 지시에 따라 편대 비행한다.
* **엑스큐션:**
...
* **해제:**
  ...
  - 머리 앞의 [성흔안](#stigmata-eyes) 두 개를 놓고 철가면을 벗으면 머리가 분리되어 고트로 변한다.
* **봉인:**
  - [성흔안](#stigmata-eyes)의 [애퍼래터스](#apparatus) 연계 능력을 사용할 수 있게 된다.
  - 고트가 머리로 변하면 철가면을 착용하고 머리 앞의 [성흔안](#stigmata-eyes) 두 개로 잡는다.
