...
* **Asylum(로물루스가 높다란 바위(돌담)로 숲을 둘러싸고 "누구든 간에, 이리로 피하라. 안전할 것이다"라고 언급한 위치)**
...
* **Inter duos lucos(두 숲 사이)(로물루스가 Asylum을 선포한 장소)**
...
* **버디 기획 이전:**
  - *미친마우스*라는 캐릭터를 구상하고 있었고, 일부 디자인을 참조했다.
    ...
    + *신성 모독*의 형상화이다.
* **버디 기획 계기:**
  - *Project 4T8G* 이전의 추상적 개념인 [BDHWBDEM](../../../../wing_corg_universe/characters/invisible_space/bdhwbdem/BDHWBDEM_Header.md)의 *그릇*이 필요했기 때문이었다.
