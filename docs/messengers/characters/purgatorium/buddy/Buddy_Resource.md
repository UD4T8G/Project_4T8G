...
* [성흔안](#stigmata-eyes)의 안광으로 주변의 모든 것이나 반작용으로 자신을 밀어낸다.
* [성흔안](#stigmata-eyes)의 안광으로 주변의 모든 것이나 바 위치와 속도를 조작한다.
...
* **안광:**
  ...
  * 적중된 모든 것을 [애퍼래터스](#apparatus)에 담는다.
  * 적중된 아군의 모든 피해를 보관한다.
  * 보관한 모든 피해를 적중된 적군에게 적용한다.
  * 보관한 모든 피해를 [애퍼래터스](#apparatus)로 정화하여 [날개](../../../core/messengers/Messengers_Resource.md#wings) 에너지를 충전한다.
...
* **봉인:**
  * [성흔안](#stigmata-eyes)의 [애퍼래터스](#apparatus) 연계 능력을 사용할 수 있게 된다.
