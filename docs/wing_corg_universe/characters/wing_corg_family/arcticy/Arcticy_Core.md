...
> *과거 북극성을 통치하던 위엄 넘치는 왕이었으나, 북극을 방문한 [윙코기](../wing_corgi/Wing_Corgi_Core.md)에게 첫눈에 반해 전형적인 왕의 권위로 청혼했다.*
...
| **Traits** | 탱커, 패링 |
| :--- | :--- |
| **Basic** | [무자비한 박치기](#ruthless_headbutt)로 근접 오브젝트 타격 |
...
| **Traits** | 투척, 광역 공격, 서포터 |
| :--- | :--- |
| **Basic** | [북극성의 방패](#shield_of_north_star)를 투척하여 공격 |
...
* **Ability:**
  * 얼음 속성 방어막 생성
  * [윙코기](../wing_corgi/Wing_Corgi_Core.md) 강화 효과 적용
* **Description:**
